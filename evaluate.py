...
preprocessed_data_path = r'C:/users/artur/Desktop/UCL/Brats2019/Data/Preprocessed'
...
writer = pd.ExcelWriter('overlap_results_{}.xlsx'.format(experiment_name), engine='xlsxwriter')
